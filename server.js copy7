    ...
    fs.readFile(filePath, 'utf8', (readErr, existingData) => {
        ...
        stream
            ...
            .on('end', () => {
                ...
                results.forEach(row => {
                    ...
                    if (!consolidatedOrders[sord]) {
                        consolidatedOrders[sord] = {
                            ...
                            "Ordered Date": null,
                            "Due Date": null,
                            "Total Logos": 0, // Initialize Total Logos (will be calculated correctly later)
                ...
                // --- Calculate Total Logos for each order (CORRECTED LOGIC) ---
                ...
                res.json(trulyNewOrders); // <-- RETURN trulyNewOrders
